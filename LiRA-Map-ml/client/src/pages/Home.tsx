    ...
    return (
        <SegmentProvider>
            <div className='home_container'>
                <h2 className="Heading">Hello, this is the Home page of the LiRA Map extension. Welcome! </h2>
                ...
                <h6>To get started please select or add a new role before you start looking at the available data.
                    After a role has been chosen or added, the Measurements page visualizes the actual measurements of the car sensors.
                    Here, you can choose between the different measurements, filter the trips according to your interest and see the
                    results in the map and graph.
                    In the Road conditions page, the calculated road conditions can be inspected. These are currently the IRI and friction
